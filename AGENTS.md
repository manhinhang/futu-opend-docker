...
| Download manually                      | `bash script/download_futu_opend.sh <tarball>`                    | Single positional arg, e.g. `Futu_OpenD_10.9.6908_Ubuntu18.04.tar.gz`; retries 3× internally               |
...
| --------------------------- | -------------------------------------- | -------------------------------------------------------------------- |
| Stable OpenD                | 10.9.6908                              | `opend_version.json` <!-- futu-opend-version -->                     |
| Beta OpenD                  | null                                   | `opend_version.json`                                                 |
| Build-arg default           | 9.3.5308                               | `Dockerfile` (legacy default; CI passes value)                       |
| `.env.example` default      | 10.9.6908                              | `.env.example` (mirrors stable on bumps) <!-- futu-opend-version --> |
